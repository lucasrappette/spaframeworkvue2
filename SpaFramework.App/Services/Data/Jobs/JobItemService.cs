...
namespace SpaFramework.App.Services.Data.Jobs
{
    public class JobItemService : EntityWriteService<JobItem, Guid>
    {
        ...
        public JobItemService(ApplicationDbContext dbContext, IConfiguration configuration, UserManager<ApplicationUser> userManager, IValidator<JobItem> validator, ILogger<EntityWriteService<JobItem, Guid>> logger, IClock clock) : base(dbContext, configuration, userManager, validator, logger)
        {
            _clock = clock;
        }
