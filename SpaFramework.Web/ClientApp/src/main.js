...
import ClientFields from './components/Client/Fields.vue'
import ClientAdd from './components/Client/Add.vue'
import ClientEdit from './components/Client/Edit.vue'
import ProjectList from './components/Project/List.vue'
import ProjectFields from './components/Project/Fields.vue'
...
const routes = [
  ...
  { path: '/client/:id', component: ClientEdit, props: route => ({ id: route.params.id })},
